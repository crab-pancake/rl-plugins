...
extends Plugin {
    ...
    protected void startUp() {
        ...
        BOSSES.addAll(Arrays.asList(5886, 5887, 5888, 5889, 5890, 5891, 5908, 6503, 6609, 5862, 5863, 5866, 2054, 6505, 319, 2215, 6494, 5779, 6499, 128, 963, 965, 4303, 4304, 6500, 6501, 239, 2642, 650, 3129, 6495, 8713, 6504, 6610, 6611, 6612, 3106, 3108, 8360, 8361, 8362, 8363, 8364, 8365, 8359, 8354, 8355, 8356, 8357, 8387, 8388, 8340, 8341, 8370, 8372, 8374, 7540, 7541, 7542, 7543, 7544, 7545, 7530, 7531, 7532, 7533, 7525, 7526, 7527, 7528, 7529, 7551, 7552, 7553, 7554, 7555, 7559, 7560, 7561, 7562, 7563, 7566, 7567, 7569, 7570, 7571, 7572, 7573, 7574, 7584, 7585, 7604, 7605, 7606, 9425, 9426, 9427, 9428, 9429, 9430, 9431, 9432, 9433, 3162, 2205, 2265, 2266, 2267, 6615, 8360, 8361, 8362, 8363, 8364, 8365, 10814, 10815, 10816, 10817, 10818, 10819, 10822, 10823, 10824, 10825, 10826, 10827, 8359, 10812, 10813, 8354, 8355, 8356, 8357, 10786, 10787, 10788, 10789, 10807, 10808, 10809, 10810, 8387, 8388, 10864, 10865, 10867, 10868, 8338, 8339, 8340, 8341, 10766, 10767, 10768, 10769, 10770, 10771, 10772, 10773, 8369, 8370, 8371, 8372, 8373, 8374, 8375, 10830, 10831, 10832, 10833, 10834, 10835, 10836, 10847, 10848, 10849, 10850, 10851, 10852, 10853));
    }
        ...
        try {
            if (this.client.getGameState() == GameState.LOGGED_IN && this.client.getLocalPlayer() != null) {
                ...
                if (payload.has("dps-clear")) {
                    ...
                    if (!(this.socketDpsConfig.onlySameWorld() && this.client.getWorld() != data.getInt("world") || data.getString("player").equals(this.client.getLocalPlayer().getName()))) {
